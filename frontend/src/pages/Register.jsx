...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4 font-['Inter'] relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#3b82f6]/20 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-[#8b5cf6]/20 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-[#8c909f] mt-2">Start collaborating in seconds</p>
        </div>
        ...
        <div className="bg-[#0b1326]/80 backdrop-blur-xl border border-[rgba(255,255,255,0.05)] p-8 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-[#8c909f] uppercase tracking-wider mb-2">Username</label>
              <input 
                type="text" 
                required
                className="w-full px-4 py-3 rounded-xl bg-[#171f33]/50 border border-[rgba(255,255,255,0.05)] text-[#dae2fd] focus:outline-none focus:border-[#3b82f6] focus:ring-1 focus:ring-[#3b82f6] transition-all placeholder:text-[#424754]"
            ...
            <div>
              <label className="block text-xs font-semibold text-[#8c909f] uppercase tracking-wider mb-2">Password</label>
              <input 
                type="password" 
                required
                minLength="8"
          ...
          <div className="mt-8 text-center text-sm text-[#8c909f]">
            ...
            <Link to="/login" className="text-[#3b82f6] hover:text-[#dae2fd] font-medium transition-colors">
              Sign In
            </Link>
          </div>
        </div>
